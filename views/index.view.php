...
$todayAttendance = $db->query("
    SELECT 
        e.full_name,
        e.employee_id,
        MIN(CASE WHEN al.event_type = 'clock_in' THEN al.timestamp END) as clock_in,
        MAX(CASE WHEN al.event_type = 'clock_out' THEN al.timestamp END) as clock_out
    FROM employees e
...
<div class="row mt-4">
            ...
            <div class="content">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php foreach (array_slice($latestLeaves, 0, 5) as $leave): ?>
                                <tr>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="content">
                <h4 class="card-title">Today's Attendance (<?= date('F d, Y') ?>)</h4>
                <div class="table-responsive">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= $attendance['clock_out']
                                            ...
                                            : ($attendance['clock_in'] ? 'Still working' : '-')
                                        ?>
                                    </td>
                                    <td>
                                        <?php
